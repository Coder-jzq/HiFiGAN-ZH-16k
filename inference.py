...
def main():
    ...
    parser.add_argument('--input_wavs_dir', default='/xxx')
    parser.add_argument('--output_dir', default='/xxx')  # MOD_V1
    parser.add_argument('--checkpoint_file', default='/xxx')
    a = parser.parse_args()

    config_file = os.path.join(os.path.split(a.checkpoint_file)[0], 'xxxconfig.json')
